...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
    ...
    FortuneTeller() throws Exception {
   	 ...
   	 fortuneTellerImage = ImageIO.read(getClass().getResource("gypsy.jpg"));
   ...
   JOptionPane.showMessageDialog(null, "Welcome to fortune teller. The hidden spot is blue.");
    }
