...
public class Backpack {
	...
	public void putInBackpack(Supply supply){
		if (supply instanceof Pencil){
			...
			JOptionPane.showMessageDialog(null, "You put your pencil in your Backpack");
		}else if(supply instanceof Ruler){
			this.ruler = (Ruler) supply;
			JOptionPane.showMessageDialog(null, "You put your ruler in your Backpack");
		}else if(supply instanceof Textbook){
			this.textbook = (Textbook) supply;
			JOptionPane.showMessageDialog(null, "You put your textbook in your Backpack");
		}else{
			JOptionPane.showMessageDialog(null, "That isn't a valid school supply");
		}
	}
